    ...
    <div class="column register-col-responsive">
      <div class="row">
        <q-card square class="shadow-24 register-card-responsive">
          ...
          <q-card-section>
            <q-form @submit.prevent="handleSubmit" class="register-form-responsive">
              <q-input
                square
                clearable
              ...
              <div v-if="formData.password" class="q-mt-md">
                ...
                <div class="text-caption">
                  <div :class="passwordValidation.checks.length ? 'text-green' : 'text-grey'">✓ At least 8 characters</div>
                  <div :class="passwordValidation.checks.uppercase ? 'text-green' : 'text-grey'">✓ Uppercase letter (A-Z)</div>
                  <div :class="passwordValidation.checks.lowercase ? 'text-green' : 'text-grey'">✓ Lowercase letter (a-z)</div>
                  <div :class="passwordValidation.checks.number ? 'text-green' : 'text-grey'">✓ Number (0-9)</div>
                  <div :class="passwordValidation.checks.special ? 'text-green' : 'text-grey'">✓ Special character (!@#$%^&*)</div>
                </div>
              </div>
...
@media (max-width: 599px) {
  .register-col-responsive { padding: 8px !important; }
  .register-card-responsive { width: 100% !important; min-width: 0; height: auto !important; }
  .register-title-responsive { font-size: 1.3rem !important; }
  .register-form-responsive { padding-left: 4px !important; padding-right: 4px !important; padding-top: 16px !important; padding-bottom: 8px !important; }
  .register-actions-responsive { padding-left: 4px !important; padding-right: 4px !important; }
  .register-section-responsive { padding: 4px !important; }
}

@media (min-width: 600px) and (max-width: 1023px) {
  .register-col-responsive { padding: 20px !important; }
  .register-card-responsive { width: 90% !important; min-width: 0; height: auto !important; }
  .register-title-responsive { font-size: 1.7rem !important; }
  .register-form-responsive { padding-left: 12px !important; padding-right: 12px !important; padding-top: 32px !important; padding-bottom: 16px !important; }
  .register-actions-responsive { padding-left: 16px !important; padding-right: 16px !important; }
  .register-section-responsive { padding: 8px !important; }
}
